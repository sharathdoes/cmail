...
export default function ProfileBento({ user }: { user: User }) {
  return (
    <main className="min-h-screen w-full bg-[#0e0e0e] text-[#e8e6e0] font-mono flex flex-col items-center justify-center px-6 py-12">
